            ...
            <main class="content">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <span>+ yangi portfolio struktura</span>
                    </div>
                ...
                <div class="admin-grid">
                    <div class="panel">
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Masalan: Ahmedov Sarvar">
                            </div>
                            <div class="form-group">
                                <label>Sinf</label>
                                <input placeholder="Masalan: 8-sinf">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel">
                        ...
                        <div class="form-box">
                            <h3>Kontent maydoni</h3>
                            <div class="form-group">
                                <label>Loyiha nomi</label>
                                <input placeholder="Muzey pedagogikasi loyihasi">
                            </div>
                            <div class="form-group">
                                <label>Tavsif</label>
                                <textarea placeholder="O‘quvchining loyiha ishi haqida qisqacha ma’lumot..."></textarea>
                            </div>
                            <button class="btn btn-secondary" style="width:100%;">Qoralama saqlash</button>
                        </div>
                    </div>
                </div>
            </main>
